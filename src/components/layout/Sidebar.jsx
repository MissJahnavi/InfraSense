...
const Sidebar = ({ currentPage, onNavigate }) => {
  ...
  const govMenuItems = [
    { id: "government", icon: Shield, label: "Gov Dashboard", highlight: true },
    { id: "profile", icon: User, label: "Profile" }, // optional
  ];

  // FIXED: Only add government menu if explicitly government
  // const menuItems = isGovernment
  //   ? [govMenuItem, ...userMenuItems]
  //   : userMenuItems;


  const menuItems = isGovernment ? govMenuItems : userMenuItems;
